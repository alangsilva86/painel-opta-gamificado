...
--> statement-breakpoint
CREATE INDEX `idx_contratos_data_pagamento` ON `contratos` (`data_pagamento`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_vendedor_nome` ON `contratos` (`vendedor_nome`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_etapa_pipeline` ON `contratos` (`etapa_pipeline`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_produto` ON `contratos` (`produto`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_tipo_operacao` ON `contratos` (`tipo_operacao`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_agente` ON `contratos` (`agente_id`);
--> statement-breakpoint
CREATE INDEX `idx_contratos_data_etapa` ON `contratos` (`data_pagamento`,`etapa_pipeline`);
--> statement-breakpoint
